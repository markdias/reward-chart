...
import { Camera, Printer, CheckCircle2, Gift } from 'lucide-react';
...
export default function PaperChartsTab({
  ...
  return (
    <div className="space-y-6 sm:space-y-8 max-w-4xl mx-auto pb-12 sm:pb-8 relative">
      <div className="flex items-center gap-3 mb-2 px-2 sm:px-0">
        ...
        <div>
          ...
          <Typography variant="body" className="text-sm text-stone-500 dark:text-stone-400">
            Print charts for the fridge, and scan them when finished.
          </Typography>
        </div>
      </div>
