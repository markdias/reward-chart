          ...
          >
            <div className="bg-white dark:bg-stone-900 border-2 border-stone-900 rounded-[1.4rem] p-3.5 sm:p-4 shadow-[inset_0_2px_4px_rgba(0,0,0,0.05)]">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-amber-400 to-emerald-500 text-white flex items-center justify-center shadow-md shrink-0 text-xl font-bold">
                  🎁
                </div>
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-2.5 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider bg-emerald-100 dark:bg-emerald-900/40 text-emerald-600 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800">
                      Waiting for parent
                    </span>
                  </div>
                  <p className="text-[11px] sm:text-xs text-stone-500 dark:text-stone-400 font-sans mt-0.5 font-medium">
                    Your parent approved your reward! Ask them for it:
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-2 pt-1 border-t border-stone-100 dark:border-stone-800">
                {approvedRedemptions.map(r => {
                  const reward = rewards.find(rw => rw.id === r.reward_id);
                  return (
                    <div key={r.id} className="flex items-center justify-between p-2.5 rounded-xl bg-amber-500/10 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/40">
                      ...
                      <span className="text-[10px] font-extrabold text-amber-600 dark:text-amber-400 bg-amber-100 dark:bg-amber-900/60 px-2.5 py-1 rounded-full border border-amber-200 dark:border-amber-700">
                        Approved - Ready!
                      </span>
                    </div>
                  );
