    ...
    <AnimatePresence>
      {modalType && (
        <Modal
          ...
          maxWidth="2xl"
          padding="lg"
          className="max-h-[85vh] overflow-y-auto border-4 border-stone-200 dark:border-stone-700"
        >
            <div className="flex justify-between items-center mb-6 border-b-2 border-stone-100 dark:border-stone-800 pb-4">
            ...
            <div className="prose prose-sm md:prose-base prose-stone max-w-none text-stone-600 dark:text-stone-300 space-y-4">
              {modalType === 'privacy' ? (
                <>
                  ...
                  <h3 className="font-bold text-stone-900 dark:text-stone-50 text-lg mt-6">1. Information We Collect</h3>
                  ...
                  <h3 className="font-bold text-stone-900 dark:text-stone-50 text-lg mt-6">2. How We Use Information</h3>
                  ...
                  <h3 className="font-bold text-stone-900 dark:text-stone-50 text-lg mt-6">3. Data Security & Storage</h3>
                  ...
                  <h3 className="font-bold text-stone-900 dark:text-stone-50 text-lg mt-6">4. Sharing of Information</h3>
                ...
                <>
                  ...
                  <h3 className="font-bold text-stone-900 dark:text-stone-50 text-lg mt-6">1. Acceptance of Terms</h3>
                  <p>By accessing or using our application, you agree to be bound by these Terms.</p>
                  
                  <h3 className="font-bold text-stone-900 dark:text-stone-50 text-lg mt-6">2. User Accounts</h3>
                  ...
                  <h3 className="font-bold text-stone-900 dark:text-stone-50 text-lg mt-6">3. Acceptable Use</h3>
                  ...
                  <h3 className="font-bold text-stone-900 dark:text-stone-50 text-lg mt-6">4. Limitation of Liability</h3>
            ...
            <div className="mt-8 pt-6 border-t-2 border-stone-100 dark:border-stone-800 flex justify-end">
