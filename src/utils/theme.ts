...
export const THEME_PRESETS: Record<ThemeId, ThemeStyles> = {
  sunny_toybox: {
    ...
    cardBg: 'bg-white rounded-2xl shadow-sm border border-stone-100 text-[#292524]',
    ...
    btnSecondary: 'bg-white border border-stone-100 text-stone-700 shadow-sm hover:bg-stone-50 active:scale-[0.98] transition-all rounded-2xl',
    ...
    inputBg: 'bg-stone-50 border border-stone-100 rounded-2xl text-stone-900 placeholder-[#A8A29E] focus:bg-white focus:border-orange-400 focus:ring-4 focus:ring-orange-400/10 focus:outline-none transition-all',
