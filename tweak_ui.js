...
content = content.replace(/text-\[10px\] font-bold text-stone-500 uppercase tracking-widest flex items-center gap-2/g, 'text-[11px] font-bold text-stone-500 uppercase tracking-widest flex items-center gap-2');
...
content = content.replace(/text-\[10px\] text-rose-700/g, 'text-xs text-rose-700');
...
content = content.replace(/text-\[10px\] font-bold text-stone-500/g, 'text-xs font-bold text-stone-500'); // the tap to flip might match here
content = content.replace(/text-\[11px\] font-bold text-stone-500 uppercase tracking-widest flex items-center gap-2/g, 'text-xs font-bold text-stone-500 uppercase tracking-widest flex items-center gap-2'); // tap to flip fix
